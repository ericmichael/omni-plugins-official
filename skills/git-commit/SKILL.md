...
9. Append a `Co-authored-by` trailer for the agent using
   `Co-authored-by: Omni Code <noreply@omnicode.dev>` unless the user
   explicitly requests a different identity.
